A [JupyterLab](https://jupyter.org/) image whose Python kernel ships with the latest stable version of [TensorFlow/Keras](https://www.tensorflow.org/tutorials) pre-installed.
